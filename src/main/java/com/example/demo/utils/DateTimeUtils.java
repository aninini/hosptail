...
public class DateTimeUtils {
    ...
    public static String dateToDateTimeString(Date date) throws ParseException {
        return com.example.demo.utils.DateTimeUtils.dateFormat(date, com.example.demo.utils.DateTimeUtils.DATE_TIME_PATTERN);
    }
    ...
    public static Date dateAdd(Date date, int days, boolean includeTime) throws ParseException {
        ...
        if (!includeTime) {
            SimpleDateFormat sdf = new SimpleDateFormat(com.example.demo.utils.DateTimeUtils.DATE_PATTERN);
    ...
    public static String dateFormat(Date date, String pattern) throws ParseException {
        if (StringUtils.isBlank(pattern)) {
            pattern = com.example.demo.utils.DateTimeUtils.DATE_PATTERN;
        }
    ...
    public static String dateTimeToDateString(Date dateTime) throws ParseException {
        String dateTimeString = com.example.demo.utils.DateTimeUtils.dateFormat(dateTime, com.example.demo.utils.DateTimeUtils.DATE_TIME_PATTERN);
