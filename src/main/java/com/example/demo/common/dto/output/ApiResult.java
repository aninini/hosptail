...
public class ApiResult {
    ...
    //添加 & 更新时的返回值操作
    public static ApiResult upJudge(boolean bool, String modMsg) {
        if (bool) {
            return new ApiResult(ResultCode.SUCCESS.getCode(), modMsg + "操作成功", null);
        } else {
            return new ApiResult(ResultCode.FAILURE.getCode(), modMsg + "操作失败", null);
        }
    }
