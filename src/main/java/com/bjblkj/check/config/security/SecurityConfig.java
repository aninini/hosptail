package com.bjblkj.check.config.security;


import com.bjblkj.check.config.security.login.AdminAuthenticationEntryPoint;
import com.bjblkj.check.config.security.url.UrlAccessDecisionManager;
import com.bjblkj.check.config.security.url.UrlAccessDeniedHandler;
import com.bjblkj.check.config.security.url.UrlFilterInvocationSecurityMetadataSource;
import com.bjblkj.check.config.MyProperties;
import com.bjblkj.check.config.security.filter.AdminAuthenticationProcessingFilter;
import com.bjblkj.check.config.security.filter.MyAuthenticationFilter;
...
//        registry.antMatchers("/**").hasRole("1");
